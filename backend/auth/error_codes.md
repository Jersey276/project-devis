...
| `1005` | INVALID_RESET_TOKEN   | 400  | The password reset token is invalid, missing, or already used.            | ConfirmResetPassword           |
| `1006` | EXPIRED_RESET_TOKEN   | 410  | The password reset token exists but is expired.                           | ConfirmResetPassword           |
| `1007` | WEAK_PASSWORD         | 422  | The submitted password does not satisfy the security policy.              | Register, ConfirmResetPassword |
...
| `2003` | NOT_IMPLEMENTED       | 501  | This endpoint is not yet implemented.                                     | UpdatePassword, VerifyEmail    |
