...
func (x *ExportInvoiceRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *ExportCreditNoteRequest) GetFacturx() bool {
	if x != nil {
		return x.Facturx
	}
	return false
...
const file_export_proto_rawDesc = "" +
	...
	"\x10ExportCreditNote\x12\x1f.export.ExportCreditNoteRequest\x1a\x1b.export.ExportQuoteResponseB+Z)project-devis-invoice/services/exportgrpcb\x06proto3"
