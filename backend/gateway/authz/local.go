...
func (a *LocalAuthorizer) Can(_ context.Context, subject Subject, action Action, resource Resource) (Decision, error) {
	...
	if resource == ResourceSubscriptionTemplates || resource == ResourceSubscriptionSchedules || resource == ResourceSubscriptionEmailTracking || resource == ResourceSubscriptionFees {
