...
const file_users_proto_rawDesc = "" +
	...
	"\x04code\x18\x02 \x01(\x05R\x04code\"\xc6\x01\n" +
	"\x04User\x12\x17\n" +
...
var file_users_proto_msgTypes = make([]protoimpl.MessageInfo, 71)
var file_users_proto_goTypes = []any{
	...
	(*GetUserAccessInfoRequest)(nil),        // 10: users.GetUserAccessInfoRequest
	(*GetUserAccessInfoByEmailRequest)(nil), // 11: users.GetUserAccessInfoByEmailRequest
	(*GetUserAccessInfoResponse)(nil),       // 12: users.GetUserAccessInfoResponse
	(*AdminAccount)(nil),                    // 13: users.AdminAccount
	(*ListAdminAccountsRequest)(nil),        // 14: users.ListAdminAccountsRequest
	(*ListAdminAccountsResponse)(nil),       // 15: users.ListAdminAccountsResponse
	(*UpdateAdminAccountRequest)(nil),       // 16: users.UpdateAdminAccountRequest
	(*SuspendAdminAccountRequest)(nil),      // 17: users.SuspendAdminAccountRequest
	(*TouchUserLastLoginRequest)(nil),       // 18: users.TouchUserLastLoginRequest
	(*Client)(nil),                          // 19: users.Client
	(*CreateClientRequest)(nil),             // 20: users.CreateClientRequest
	(*CreateClientResponse)(nil),            // 21: users.CreateClientResponse
	(*GetClientRequest)(nil),                // 22: users.GetClientRequest
	(*GetClientResponse)(nil),               // 23: users.GetClientResponse
	(*ListClientsRequest)(nil),              // 24: users.ListClientsRequest
	(*ListClientsResponse)(nil),             // 25: users.ListClientsResponse
	(*UpdateClientRequest)(nil),             // 26: users.UpdateClientRequest
	(*UpdateClientResponse)(nil),            // 27: users.UpdateClientResponse
	(*ArchiveClientRequest)(nil),            // 28: users.ArchiveClientRequest
	(*Address)(nil),                         // 29: users.Address
	(*CreateAddressRequest)(nil),            // 30: users.CreateAddressRequest
	(*CreateAddressResponse)(nil),           // 31: users.CreateAddressResponse
	(*GetAddressRequest)(nil),               // 32: users.GetAddressRequest
	(*GetAddressResponse)(nil),              // 33: users.GetAddressResponse
	(*ListAddressesRequest)(nil),            // 34: users.ListAddressesRequest
	(*ListAddressesResponse)(nil),           // 35: users.ListAddressesResponse
	(*UpdateAddressRequest)(nil),            // 36: users.UpdateAddressRequest
	(*UpdateAddressResponse)(nil),           // 37: users.UpdateAddressResponse
	(*ArchiveAddressRequest)(nil),           // 38: users.ArchiveAddressRequest
	(*Country)(nil),                         // 39: users.Country
	(*CreateCountryRequest)(nil),            // 40: users.CreateCountryRequest
	(*CreateCountryResponse)(nil),           // 41: users.CreateCountryResponse
	(*GetCountryRequest)(nil),               // 42: users.GetCountryRequest
	(*GetCountryResponse)(nil),              // 43: users.GetCountryResponse
	(*ListCountriesRequest)(nil),            // 44: users.ListCountriesRequest
	(*ListCountriesResponse)(nil),           // 45: users.ListCountriesResponse
	(*UpdateCountryRequest)(nil),            // 46: users.UpdateCountryRequest
	(*UpdateCountryResponse)(nil),           // 47: users.UpdateCountryResponse
	(*DeleteCountryRequest)(nil),            // 48: users.DeleteCountryRequest
	(*CountryGroup)(nil),                    // 49: users.CountryGroup
	(*CreateCountryGroupRequest)(nil),       // 50: users.CreateCountryGroupRequest
	(*CreateCountryGroupResponse)(nil),      // 51: users.CreateCountryGroupResponse
	(*GetCountryGroupRequest)(nil),          // 52: users.GetCountryGroupRequest
	(*GetCountryGroupResponse)(nil),         // 53: users.GetCountryGroupResponse
	(*ListCountryGroupsRequest)(nil),        // 54: users.ListCountryGroupsRequest
	(*ListCountryGroupsResponse)(nil),       // 55: users.ListCountryGroupsResponse
	(*UpdateCountryGroupRequest)(nil),       // 56: users.UpdateCountryGroupRequest
	(*UpdateCountryGroupResponse)(nil),      // 57: users.UpdateCountryGroupResponse
	(*DeleteCountryGroupRequest)(nil),       // 58: users.DeleteCountryGroupRequest
	(*AttachCountryRequest)(nil),            // 59: users.AttachCountryRequest
	(*DetachCountryRequest)(nil),            // 60: users.DetachCountryRequest
	(*Tax)(nil),                             // 61: users.Tax
	(*CreateTaxRequest)(nil),                // 62: users.CreateTaxRequest
	(*CreateTaxResponse)(nil),               // 63: users.CreateTaxResponse
	(*GetTaxRequest)(nil),                   // 64: users.GetTaxRequest
	(*GetTaxResponse)(nil),                  // 65: users.GetTaxResponse
	(*ListTaxesRequest)(nil),                // 66: users.ListTaxesRequest
	(*ListTaxesForUserRequest)(nil),         // 67: users.ListTaxesForUserRequest
	(*ListTaxesResponse)(nil),               // 68: users.ListTaxesResponse
	(*UpdateTaxRequest)(nil),                // 69: users.UpdateTaxRequest
	(*UpdateTaxResponse)(nil),               // 70: users.UpdateTaxResponse
	(*DeleteTaxRequest)(nil),                // 71: users.DeleteTaxRequest
}
var file_users_proto_depIdxs = []int32{
	2,  // 0: users.GetUserResponse.user:type_name -> users.User
	13, // 1: users.ListAdminAccountsResponse.accounts:type_name -> users.AdminAccount
	19, // 2: users.GetClientResponse.client:type_name -> users.Client
	19, // 3: users.ListClientsResponse.clients:type_name -> users.Client
	0,  // 4: users.Address.owner_type:type_name -> users.OwnerType
	0,  // 5: users.CreateAddressRequest.owner_type:type_name -> users.OwnerType
	0,  // 6: users.GetAddressRequest.owner_type:type_name -> users.OwnerType
	29, // 7: users.GetAddressResponse.address:type_name -> users.Address
	0,  // 8: users.ListAddressesRequest.owner_type:type_name -> users.OwnerType
	29, // 9: users.ListAddressesResponse.addresses:type_name -> users.Address
	0,  // 10: users.UpdateAddressRequest.owner_type:type_name -> users.OwnerType
	0,  // 11: users.ArchiveAddressRequest.owner_type:type_name -> users.OwnerType
	39, // 12: users.GetCountryResponse.country:type_name -> users.Country
	39, // 13: users.ListCountriesResponse.countries:type_name -> users.Country
	39, // 14: users.CountryGroup.countries:type_name -> users.Country
	61, // 15: users.CountryGroup.taxes:type_name -> users.Tax
	49, // 16: users.GetCountryGroupResponse.country_group:type_name -> users.CountryGroup
	49, // 17: users.ListCountryGroupsResponse.country_groups:type_name -> users.CountryGroup
	61, // 18: users.GetTaxResponse.tax:type_name -> users.Tax
	61, // 19: users.ListTaxesResponse.taxes:type_name -> users.Tax
	3,  // 20: users.UserService.CreateUser:input_type -> users.CreateUserRequest
	5,  // 21: users.UserService.GetUser:input_type -> users.GetUserRequest
	7,  // 22: users.UserService.UpdateUser:input_type -> users.UpdateUserRequest
	9,  // 23: users.UserService.DeleteUser:input_type -> users.DeleteUserRequest
	10, // 24: users.UserService.GetUserAccessInfo:input_type -> users.GetUserAccessInfoRequest
	11, // 25: users.UserService.GetUserAccessInfoByEmail:input_type -> users.GetUserAccessInfoByEmailRequest
	14, // 26: users.UserService.ListAdminAccounts:input_type -> users.ListAdminAccountsRequest
	16, // 27: users.UserService.UpdateAdminAccount:input_type -> users.UpdateAdminAccountRequest
	17, // 28: users.UserService.SuspendAdminAccount:input_type -> users.SuspendAdminAccountRequest
	18, // 29: users.UserService.TouchUserLastLogin:input_type -> users.TouchUserLastLoginRequest
	20, // 30: users.UserService.CreateClient:input_type -> users.CreateClientRequest
	22, // 31: users.UserService.GetClient:input_type -> users.GetClientRequest
	24, // 32: users.UserService.ListClients:input_type -> users.ListClientsRequest
	26, // 33: users.UserService.UpdateClient:input_type -> users.UpdateClientRequest
	28, // 34: users.UserService.ArchiveClient:input_type -> users.ArchiveClientRequest
	30, // 35: users.UserService.CreateAddress:input_type -> users.CreateAddressRequest
	32, // 36: users.UserService.GetAddress:input_type -> users.GetAddressRequest
	34, // 37: users.UserService.ListAddresses:input_type -> users.ListAddressesRequest
	36, // 38: users.UserService.UpdateAddress:input_type -> users.UpdateAddressRequest
	38, // 39: users.UserService.ArchiveAddress:input_type -> users.ArchiveAddressRequest
	40, // 40: users.UserService.CreateCountry:input_type -> users.CreateCountryRequest
	42, // 41: users.UserService.GetCountry:input_type -> users.GetCountryRequest
	44, // 42: users.UserService.ListCountries:input_type -> users.ListCountriesRequest
	46, // 43: users.UserService.UpdateCountry:input_type -> users.UpdateCountryRequest
	48, // 44: users.UserService.DeleteCountry:input_type -> users.DeleteCountryRequest
	50, // 45: users.UserService.CreateCountryGroup:input_type -> users.CreateCountryGroupRequest
	52, // 46: users.UserService.GetCountryGroup:input_type -> users.GetCountryGroupRequest
	54, // 47: users.UserService.ListCountryGroups:input_type -> users.ListCountryGroupsRequest
	56, // 48: users.UserService.UpdateCountryGroup:input_type -> users.UpdateCountryGroupRequest
	58, // 49: users.UserService.DeleteCountryGroup:input_type -> users.DeleteCountryGroupRequest
	59, // 50: users.UserService.AttachCountry:input_type -> users.AttachCountryRequest
	60, // 51: users.UserService.DetachCountry:input_type -> users.DetachCountryRequest
	62, // 52: users.UserService.CreateTax:input_type -> users.CreateTaxRequest
	64, // 53: users.UserService.GetTax:input_type -> users.GetTaxRequest
	66, // 54: users.UserService.ListTaxes:input_type -> users.ListTaxesRequest
	67, // 55: users.UserService.ListTaxesForUser:input_type -> users.ListTaxesForUserRequest
	69, // 56: users.UserService.UpdateTax:input_type -> users.UpdateTaxRequest
	71, // 57: users.UserService.DeleteTax:input_type -> users.DeleteTaxRequest
	4,  // 58: users.UserService.CreateUser:output_type -> users.CreateUserResponse
	6,  // 59: users.UserService.GetUser:output_type -> users.GetUserResponse
	8,  // 60: users.UserService.UpdateUser:output_type -> users.UpdateUserResponse
	1,  // 61: users.UserService.DeleteUser:output_type -> users.GenericResponse
	12, // 62: users.UserService.GetUserAccessInfo:output_type -> users.GetUserAccessInfoResponse
	12, // 63: users.UserService.GetUserAccessInfoByEmail:output_type -> users.GetUserAccessInfoResponse
	15, // 64: users.UserService.ListAdminAccounts:output_type -> users.ListAdminAccountsResponse
	1,  // 65: users.UserService.UpdateAdminAccount:output_type -> users.GenericResponse
	1,  // 66: users.UserService.SuspendAdminAccount:output_type -> users.GenericResponse
	1,  // 67: users.UserService.TouchUserLastLogin:output_type -> users.GenericResponse
	21, // 68: users.UserService.CreateClient:output_type -> users.CreateClientResponse
	23, // 69: users.UserService.GetClient:output_type -> users.GetClientResponse
	25, // 70: users.UserService.ListClients:output_type -> users.ListClientsResponse
	27, // 71: users.UserService.UpdateClient:output_type -> users.UpdateClientResponse
	1,  // 72: users.UserService.ArchiveClient:output_type -> users.GenericResponse
	31, // 73: users.UserService.CreateAddress:output_type -> users.CreateAddressResponse
	33, // 74: users.UserService.GetAddress:output_type -> users.GetAddressResponse
	35, // 75: users.UserService.ListAddresses:output_type -> users.ListAddressesResponse
	37, // 76: users.UserService.UpdateAddress:output_type -> users.UpdateAddressResponse
	1,  // 77: users.UserService.ArchiveAddress:output_type -> users.GenericResponse
	41, // 78: users.UserService.CreateCountry:output_type -> users.CreateCountryResponse
	43, // 79: users.UserService.GetCountry:output_type -> users.GetCountryResponse
	45, // 80: users.UserService.ListCountries:output_type -> users.ListCountriesResponse
	47, // 81: users.UserService.UpdateCountry:output_type -> users.UpdateCountryResponse
	1,  // 82: users.UserService.DeleteCountry:output_type -> users.GenericResponse
	51, // 83: users.UserService.CreateCountryGroup:output_type -> users.CreateCountryGroupResponse
	53, // 84: users.UserService.GetCountryGroup:output_type -> users.GetCountryGroupResponse
	55, // 85: users.UserService.ListCountryGroups:output_type -> users.ListCountryGroupsResponse
	57, // 86: users.UserService.UpdateCountryGroup:output_type -> users.UpdateCountryGroupResponse
	1,  // 87: users.UserService.DeleteCountryGroup:output_type -> users.GenericResponse
	1,  // 88: users.UserService.AttachCountry:output_type -> users.GenericResponse
	1,  // 89: users.UserService.DetachCountry:output_type -> users.GenericResponse
	63, // 90: users.UserService.CreateTax:output_type -> users.CreateTaxResponse
	65, // 91: users.UserService.GetTax:output_type -> users.GetTaxResponse
	68, // 92: users.UserService.ListTaxes:output_type -> users.ListTaxesResponse
	68, // 93: users.UserService.ListTaxesForUser:output_type -> users.ListTaxesResponse
	70, // 94: users.UserService.UpdateTax:output_type -> users.UpdateTaxResponse
	1,  // 95: users.UserService.DeleteTax:output_type -> users.GenericResponse
